...
#ifdef __TRACE_SOLVER__
static void traceLPTablo(TLinearProgram *lp, double *t, int rows, int cols)
{
...
//**********************************************************
// the solver using simplex algorithm
//
// in: linear program structure
// out: solution or NULL
//**********************************************************
